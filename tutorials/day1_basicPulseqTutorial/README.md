...
This directory contains materials for the *Basic Pulseq tutorials* for the ISMRM Virtual Meeting 2026.
...
* s01_fid: FID sequence
* s02_fid2gre1d: from FID to 1D GRE
* s03_gre1d2gre2d:from 1D GRE to 2D GRE

## Necessary technical preparation steps for Jupyter Notebook
